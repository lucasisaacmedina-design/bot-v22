...
def motor_v45():
    ...
    print(f">>> MOTOR V50.6.3 LIMPIO {len(MONEDAS_ACTIVAS)}/{MAX_MONEDAS} KRAKEN 30/35")
    time.sleep(5)
    while True:
        try:
...
def start(m):
    ...
    estado_txt = f"🟢 V50.6.3 LIMPIO {len(MONEDAS_ACTIVAS)}/{MAX_MONEDAS}" if u["prendido"] else "🔴 APAGADO"
